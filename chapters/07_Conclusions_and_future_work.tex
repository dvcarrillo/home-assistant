...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|c|l|}
			...
			\begin{tabular}[c]{@{}l@{}}1. Integrate a home automation \\ system in a embedded system\end{tabular} & 100\% & \begin{tabular}[c]{@{}l@{}}I have successfully installed and integrated\\ openHAB in the Raspberry Pi\end{tabular} \\ \hline
			...
			\begin{tabular}[c]{@{}l@{}}3. Explore current home \\ automation systems and \\ voice assistants, focusing \\ on open-source solutions\end{tabular} & 80\% & \begin{tabular}[c]{@{}l@{}}I have explored some of these systems on\\ Chapter 3, but the inclusion of open source\\ solutions has been reduced\end{tabular} \\ \hline
			\begin{tabular}[c]{@{}l@{}}4. Explore automation \\ possibilities and implement\\ an automation service in the \\ domotic system\end{tabular} & 70\% & \begin{tabular}[c]{@{}l@{}}I have successfully implemented an \\ automation service using IFTTT and \\ the REST API of openHAB. Some other \\ services might have been explored\end{tabular} \\ \hline
			...
			\begin{tabular}[c]{@{}l@{}}6. Explore options for \\ providing global access to \\ the system and implement one\end{tabular} & 100\% & \begin{tabular}[c]{@{}l@{}}I have explored these options on Chapter 6 \\ and I have tested the service \\ myopenHAB\end{tabular} \\ \hline
			\begin{tabular}[c]{@{}l@{}}7. Explore safety and privacy \\ concerns related to the home \\ automation system\end{tabular} & 30\% & \begin{tabular}[c]{@{}l@{}}Some safety concerns have been covered\\ through this work, but I have not covered\\ the main aspects related to privacy\end{tabular} \\ \hline
			\begin{tabular}[c]{@{}l@{}}8. Provide an adaptive and \\ responsive user interface, \\ usable on touch and non-touch \\ screens\end{tabular} & 100\% & \begin{tabular}[c]{@{}l@{}}I explained how to configure Basic UI and\\ PaperUI. Both user interfaces comply \\ with these points\end{tabular} \\ \hline
...
The table \ref{table:fulfillment-objectives} presents the fulfillment level of the specific objectives that I presented in the 
