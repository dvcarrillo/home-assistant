\chapter{Voice-Driven Home Automation Controller}
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[width=0.65\textwidth]{images/Chapter_07/persona-oswald-douglas.png}
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[width=0.65\textwidth]{images/Chapter_07/persona-anna-lahtinen.png}
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[width=0.65\textwidth]{images/Chapter_07/persona-rosario-vera.png}
...
Next, we detail the use cases of this subsystem:
\begin{itemize}
...
\begin{figure}
	\centering
	\includegraphics[width=1\textwidth]{images/Chapter_07/system-architecture.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{images/Chapter_07/hue-color-bulb-channels.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{images/Chapter_07/openhab-control-hue.png}
