...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|}
			...
			Raspberry Pi 3 Model B+ & 1 & EUR 40 \\ \hline
			SanDisk microSDHC UHS-I 16GB & 1 & EUR 10 \\ \hline
			Google AIY Voice Kit & 1 & EUR 34 \\ \hline
			\begin{tabular}[c]{@{}l@{}}Philips Hue White and Color Ambiance Starter Kit\\ (Twin Pack Bulb with Bridge)\end{tabular} & 1 & EUR 90 \\ \hline
			\multicolumn{2}{|l|}{\textbf{TOTAL}} & \textbf{EUR 174} \\ \hline
		\end{tabular}%
	}
