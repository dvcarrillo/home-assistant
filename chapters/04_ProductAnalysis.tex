...
\begin{sidewaystable}[]
	\begin{center}
		...
		\begin{tabular}{|p{0.1\linewidth}|p{0.15\linewidth}|p{0.05\linewidth}|p{0.05\linewidth}|p{0.15\linewidth}|p{0.15\linewidth}|p{0.1\linewidth}|p{0.1\linewidth}|p{0.39\linewidth}|}
			...
			Jeedom               & Jeedom SAS                                            & Part.             & Part.           & Decentralized         & A computer with Internet connection or a Jeedom Box & Mobile app                                                     & Jeedom Boxes                          & Compatible with devices and services from different makers                                                      \\ \hline
		\end{tabular}}
...
The objective of this section is to explore the main voice assistants available commercially, focusing mainly on the ones that also
